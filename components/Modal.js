      ...
      <div className="bg-yellow-500 shadow-md  px-8 pt-6 mb-4 lg:w-1/2 mt-0 mx-auto rounded  z-50 overflow-y-auto">
        <div className="py-4 text-left px-6">
          <div className="flex justify-between items-center pb-3">
            <p className="text-xl lg:text-3xl mb-4 text-center pt-2 mt-2 text-white font-bold">
              Add token&apos;s data.
            </p>
          ...
          <div className="mb-4 flex flex-col p-4 space-y-4 lg:flex-col lg:space-y-4"></div>
          <div>{children}</div>
        </div>
      </div>
    </div>
