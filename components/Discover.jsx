    ...
    <div className="text-white font-bold p-4 grid">
      ...
      <div className="grid lg:flex lg:justify-center lg:items-center lg:pt-40">
        ...
        <div className="mb-6 justify-start md:mb-54 lg:w-1/2 lg:mt-0">
          <h2 className="text-white text-2xl pb-2 text-center md:text-4xl lg:text-5xl mb-0 lg:text-center">
            {selectedItem.title}
          </h2>
          <p className="text-white pl-4 mb-18 sm:text-sm md:text-2xl lg:text-2xl lg:mb-38 lg:mt-20 lg:text-center lg:mr-8">
