        ...
        <LeviReveal>
          <div className="levi-bitcoin-hero-copy">
            <Link href="/learn" className="levi-bitcoin-back-link">
              <ArrowLeft className="h-4 w-4" /> Back to Bullish Mule Learn
            </Link>
      ...
      <section className="levi-container levi-bitcoin-close">
        <LeviReveal>
          ...
          <p>
            ...
            Return to Bullish Mule Learn for the practical discipline, liquidity and risk material
            that belongs alongside any market research.
          </p>
          <Link href="/learn" className="levi-secondary-button mt-7">
            Return to Bullish Mule Learn <ArrowLeft className="h-4 w-4" />
          </Link>
        </LeviReveal>
      </section>
    </div>
