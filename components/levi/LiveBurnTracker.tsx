    ...
    >
      <div className="levi-burn-tracker-header">
        <div>
          ...
          <p>
            Verified Solana burn instructions reduce MULE supply. Permanent community
        ...
        <Link href="/burn" className="levi-burn-tracker-action">
          Burn MULE <ArrowUpRight className="h-3.5 w-3.5" />
        </Link>
      </div>
            ...
            {isLoading && !snapshot ? (
              ...
              <>
                ...
                <article className="levi-burn-tracker-metric">
                  ...
                  <strong>
                    {formatRawTokenAmount(
                      snapshot.effectiveCirculatingSupplyRaw,
                      snapshot.decimals
                    )}{" "}
                    {snapshot.symbol}
                  </strong>
                ...
                <article className="levi-burn-tracker-metric">
                  ...
                  <p>
                    Of the{" "}
                    {formatRawTokenAmount(
                      snapshot.initialSupplyRaw,
                      snapshot.decimals
                    )}{" "}
                    {snapshot.symbol} baseline.
                  </p>
                </article>
            ...
            <div className="levi-burn-tracker-footer">
              ...
              <div className="levi-burn-tracker-lock">
                ...
                <div>
                  ...
                  <strong>
                    {formatRawTokenAmount(
                      snapshot.communityLockRaw,
                      snapshot.decimals
                    )}{" "}
                    {snapshot.symbol} permanently locked
                  </strong>
