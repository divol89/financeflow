...
import { Activity, ArrowDownLeft, ArrowUpRight, MoveRight } from "lucide-react";
    ...
    <section className="levi-scanner-activity-chart" aria-labelledby="scanner-activity-chart-title">
      <header className="levi-scanner-chart-header">
        <div>
          ...
          <h3 id="scanner-activity-chart-title">Buys, sells and token flow</h3>
          <p>Each point comes from the same parsed transactions used by the evidence table below.</p>
        </div>
